<template>
    <div id="menuAdmin">
        <b-card-group deck>
            <b-card border-variant="primary" header="Resultado Mensal" header-bg-variant="primary"
                header-text-variant="white" align="center" @click="$router.push('/ResultadoMensalAdmin')">
